...
excerpt: "A spatially and temporally local learning rule derived from a VICReg-style objective"
...
Temporal Regularized Learning (TeReL) is a self-supervised procedure that optimizes each neuron individually, without backpropagation. It adapts a VICReg-style objective to input streams with sequential coherence, making it online-compatible.
