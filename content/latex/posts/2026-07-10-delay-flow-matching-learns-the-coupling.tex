...
\section{1. Flow matching setup}\label{flow-matching-setup}
...
\section{2. Delay FM's objective}\label{delay-fms-objective}
...
\section{3. Endpoint recovery from two trajectory points}\label{endpoint-recovery-from-two-trajectory-points}
...
\section{4. Gradients and trajectory continuation}\label{gradients-and-trajectory-continuation}

Flow-matching models are trained by sampling endpoint pairs, sampling times, constructing the corresponding trajectory points, and minimizing mean squared error to the target vector \(u_t\). This simulation-free regression view is the common backbone of flow matching, conditional flow matching, and stochastic interpolants (\href{https://arxiv.org/abs/2210.02747}{Lipman et al.~2022}, \href{https://arxiv.org/abs/2302.00482}{Tong et al.~2023}, \href{https://arxiv.org/abs/2303.08797}{Albergo et al.~2023}). For DFM, the per-sample gradient at \(t>0\) has the form
...
For the straight schedule used by rectified-flow and OT-style FM constructions (\href{https://arxiv.org/abs/2209.03003}{Liu et al.~2022}, \href{https://arxiv.org/abs/2302.00482}{Tong et al.~2023}, \href{https://arxiv.org/abs/2304.14772}{Pooladian et al.~2023}),
...
For a cosine or VP-style schedule, as used in diffusion and score-SDE parameterizations (\href{https://arxiv.org/abs/2006.11239}{Ho et al.~2020}, \href{https://arxiv.org/abs/2011.13456}{Song et al.~2020}, \href{https://arxiv.org/abs/2210.02747}{Lipman et al.~2022}),
...
This is why DFM is best interpreted as a close relative of source-conditioned FM and Augmented Bridge Matching. Here source-conditioned FM means the variant in which the vector field also receives the source endpoint \(x_0\). Augmented Bridge Matching studies the same kind of augmentation in bridge matching and shows how it preserves empirical pairings (\href{https://arxiv.org/abs/2311.06978}{De Bortoli et al.~2023}). DFM has a similar effect because the earlier trajectory point can identify the endpoint pair. In this setting, the schedule supplies the continuation formula, and the learned part is the coupling. The next two sections spell out two consequences.

\section{5. Sampling efficiently from DFM models}\label{sampling-efficiently-from-dfm-models}
...
Additional network calls may still change a finite-capacity numerical rollout. They do not add endpoint information in the fitted endpoint-determined setting. This endpoint readout is also different from distillation or learned flow-map methods, which train an additional map to reduce the number of integration steps (\href{https://arxiv.org/abs/2406.07507}{Boffi et al.~2024}), since it is exact for a fitted model, reducing the required number of forward passes from (\textbackslash O(n)) to (\textbackslash O(1)).

\section{6. Coupling choice}\label{coupling-choice}
...
DFM is most natural when the endpoint pairing is meaningful. The pairing might come from known source-target examples, optimal transport, minibatch matching, bridge matching, or another domain-specific construction (\href{https://arxiv.org/abs/2302.00482}{Tong et al.~2023}, \href{https://arxiv.org/abs/2304.14772}{Pooladian et al.~2023}, \href{https://arxiv.org/abs/2303.16852}{Shi et al.~2023}, \href{https://arxiv.org/abs/2307.03672}{Tong et al.~2023b}, \href{https://arxiv.org/abs/2311.06978}{De Bortoli et al.~2023}). In those cases, the extra input gives the model information that the task actually wants to preserve.

\section{7. Delayed dynamical systems}\label{delayed-dynamical-systems}
...
the earlier state \(x(t-\tau)\) is part of the physical state. It is not merely a code for a sampled endpoint pair. The path is not an interpolation between two endpoints. This is the setting where neural DDE models and trajectory-oriented flow-matching methods are relevant rather than just endpoint-pair interpolation (\href{https://arxiv.org/abs/1806.07366}{Chen et al.~2018}, \href{https://arxiv.org/abs/2102.10801}{Zhu et al.~2021}, \href{https://arxiv.org/abs/2410.21154}{Zhang et al.~2024}, \href{https://openreview.net/forum?id=6lH1XblLpo}{Zhao et al.~2026}).
...
\tightlist
\item
  Zhao et al., \href{https://openreview.net/forum?id=6lH1XblLpo}{Delay Flow Matching}, ICLR 2026.
\item
  Lipman et al., \href{https://arxiv.org/abs/2210.02747}{Flow Matching for Generative Modeling}, 2022.
\item
  Tong et al., \href{https://arxiv.org/abs/2302.00482}{Improving and generalizing flow-based generative models with minibatch optimal transport}, 2023.
\item
  Albergo et al., \href{https://arxiv.org/abs/2303.08797}{Stochastic Interpolants: A Unifying Framework for Flows and Diffusions}, 2023.
\item
  Liu et al., \href{https://arxiv.org/abs/2209.03003}{Flow Straight and Fast}, 2022.
\item
  Pooladian et al., \href{https://arxiv.org/abs/2304.14772}{Multisample Flow Matching}, 2023.
\item
  Ho et al., \href{https://arxiv.org/abs/2006.11239}{Denoising Diffusion Probabilistic Models}, 2020.
\item
  Song et al., \href{https://arxiv.org/abs/2011.13456}{Score-Based Generative Modeling through Stochastic Differential Equations}, 2020.
\item
  De Bortoli et al., \href{https://arxiv.org/abs/2311.06978}{Augmented Bridge Matching}, 2023.
\item
  Shi et al., \href{https://arxiv.org/abs/2303.16852}{Diffusion Schrödinger Bridge Matching}, 2023.
\item
  Tong et al., \href{https://arxiv.org/abs/2307.03672}{Simulation-free Schrödinger bridges via score and flow matching}, 2023.
\item
  Boffi et al., \href{https://arxiv.org/abs/2406.07507}{Flow Map Matching}, 2024.
\item
  Chen et al., \href{https://arxiv.org/abs/1806.07366}{Neural Ordinary Differential Equations}, 2018.
\item
  Zhu et al., \href{https://arxiv.org/abs/2102.10801}{Neural Delay Differential Equations}, 2021.
\item
  Zhang et al., \href{https://arxiv.org/abs/2410.21154}{Trajectory Flow Matching with Applications to Clinical Time Series Modeling}, 2024.
\end{itemize}
