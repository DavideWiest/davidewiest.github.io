...
\section{1. The Object}\label{the-object}
...
where each \(\mathcal{M}_j\) has its own intrinsic dimension. Consequently, if a proposed partition tracks the actual pieces, then the estimated intrinsic dimensions of the parts vary more than equally sized random parts. Brown et al.~used this principle for image classes in \href{https://arxiv.org/abs/2207.02862}{Verifying the Union of Manifolds Hypothesis for Image Data}, and their public code exposes the estimator needed for the test through \href{https://github.com/layer6ai-labs/UoMH}{\texttt{layer6ai-labs/UoMH}}.
...
\section{2. Protocol}\label{protocol}
...
\section{5. Consequences}\label{consequences}
...
\section{References And Artifacts}\label{references-and-artifacts}

\begin{itemize}
\tightlist
\item
  Brown et al., \href{https://arxiv.org/abs/2207.02862}{Verifying the Union of Manifolds Hypothesis for Image Data}
\item
  Official UoMH code, \href{https://github.com/layer6ai-labs/UoMH}{\texttt{layer6ai-labs/UoMH}}
\item
  Wang and Wang, \href{https://proceedings.mlr.press/v235/wang24bs.html}{CW Complex Hypothesis for Image Data}
\item
  Schulte and Ruegamer, \href{https://arxiv.org/abs/2604.20276}{Rethinking Intrinsic Dimension Estimation in Neural Representations}
\item
  Reimers and Gurevych, \href{https://arxiv.org/abs/1908.10084}{Sentence-BERT}
\item
  Project repository, \href{https://github.com/Axym-Labs/uomh-beyond-classification}{\texttt{Axym-Labs/uomh-beyond-classification}}
\item
  Confirmatory artifacts, \href{https://github.com/Axym-Labs/uomh-beyond-classification/tree/main/docs/recursive-uomh-protocol/artifacts/confirmatory-r19-20260628}{\texttt{confirmatory-r19-20260628}}
\item
  Screening artifacts, \href{https://github.com/Axym-Labs/uomh-beyond-classification/tree/main/docs/recursive-uomh-protocol/artifacts/final-run-20260628-recursive}{\texttt{final-run-20260628-recursive}}
\end{itemize}
